...
- **Recommendations for our benchmark** — direct, actionable recommendations covering paper structure, repo organization, results presentation, limitations handling, and launch strategy.
