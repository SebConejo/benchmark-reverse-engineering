...
any of the 21 tasks (Mann-Whitney $p > 0.05$, 21/21;
$n_{\text{Premium}} = 2$).  Within providers, paying 750$\times$ more
...
\item \textit{Per-task routing saves 99.7\%.}  Routing to the cheapest
  ...
  o3, with at most 0.2 points quality difference on any single task.
...
cost-quality curve is flat: on no task did we detect a significant
difference between Economy and Premium tiers ($n_{\text{Premium}} = 2$;
more Premium models are needed to confirm this pattern).  The practical
